...
const ConfigBackupField kConfigBackupFields[] = {
    ...
    BOOL_FIELD("web_password_protection", web_password_protection),
    BOOL_FIELD("web_dark_mode", web_dark_mode),
    ...
    TEXT_FIELD("matrix_origin", matrix_origin),
    TEXT_FIELD("matrix_corner", matrix_corner),
    TEXT_FIELD("matrix_axis", matrix_axis),
    TEXT_FIELD("matrix_order", matrix_order),
    ...
    BOOL_FIELD("current_weather_short_text", current_weather_short_text),
    ...
    BOOL_FIELD("daily_weather_short_text", daily_weather_short_text),
